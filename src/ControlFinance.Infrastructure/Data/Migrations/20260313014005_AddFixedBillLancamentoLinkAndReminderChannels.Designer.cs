...
namespace ControlFinance.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260313014005_AddFixedBillLancamentoLinkAndReminderChannels")]
    partial class AddFixedBillLancamentoLinkAndReminderChannels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControlFinance.Domain.Entities.LembretePagamento", b =>
                {
                    ...
                    b.Property<bool>("LembreteWhatsAppAtivo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("lembrete_whatsapp_ativo");
            ...
            modelBuilder.Entity("ControlFinance.Domain.Entities.PagamentoCiclo", b =>
                {
                    ...
                    b.HasIndex("LancamentoId")
                        .IsUnique()
                        .HasFilter("lancamento_id IS NOT NULL");
            ...
            modelBuilder.Entity("ControlFinance.Domain.Entities.PlanoConfig", b =>
                {
                    ...
                    b.Property<bool>("StripeGerenciadoAutomaticamente")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("stripe_gerenciado_automaticamente");
                    ...
                    b.Property<string>("StripeInterval")
                        ...
                        .HasColumnName("stripe_interval");

                    b.Property<string>("StripeLookupKey")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("stripe_lookup_key");
            ...
            modelBuilder.Entity("ControlFinance.Domain.Entities.PromocaoPlano", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("StripePromotionCode")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("stripe_promotion_code");

                    b.Property<int>("TipoPromocao")
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("PlanoConfigId", "Ordem");

                    b.ToTable("promocoes_plano", (string)null);
                });
            ...
            modelBuilder.Entity("ControlFinance.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.Property<DateTime?>("TrialConsumidoEm")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("trial_consumido_em");
            ...
            modelBuilder.Entity("ControlFinance.Domain.Entities.PagamentoCiclo", b =>
                {
                    b.HasOne("ControlFinance.Domain.Entities.Lancamento", "Lancamento")
                        .WithOne("PagamentoCicloOrigem")
                        .HasForeignKey("ControlFinance.Domain.Entities.PagamentoCiclo", "LancamentoId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("ControlFinance.Domain.Entities.Lancamento", b =>
                {
                    b.Navigation("PagamentoCicloOrigem");
