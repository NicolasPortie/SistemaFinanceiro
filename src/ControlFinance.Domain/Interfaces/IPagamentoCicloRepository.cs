...
public interface IPagamentoCicloRepository
{
    ...
    Task<PagamentoCiclo?> ObterPorLancamentoIdAsync(int lancamentoId);
    ...
    Task<HashSet<int>> ObterIdsComCiclosPagoAsync(IReadOnlyDictionary<int, string> periodKeysPorLembrete);
}
