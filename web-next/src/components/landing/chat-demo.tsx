...
import { Sparkles, Mic, Camera, CheckCircle2, AlertCircle } from "lucide-react";
      ...
      content: (
        <>
          ...
          <p className="text-[15px] leading-relaxed mb-4 text-stone-700">
            Nota processada! 🛒 Identifiquei 32 itens. Lancei{" "}
            <strong className="text-stone-900 font-semibold">R$ 230,00</strong> em Mercado e{" "}
            <strong className="text-stone-900 font-semibold">R$ 45,00</strong> em Higiene Pessoal.
          </p>
          <div className="bg-stone-50 rounded-xl p-3 text-sm border border-stone-200 flex items-center justify-between">
            ...
            <span className="text-emerald-700 font-bold text-xs bg-emerald-100 px-2 py-1 rounded">
              OK
            </span>
          </div>
        </>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="text-[15px] leading-relaxed mb-4 text-stone-700">
            Pronto! Registrei <strong className="text-stone-900 font-semibold">R$ 150,00</strong> na
            categoria <strong className="text-stone-900 font-semibold">Combustível</strong>.
          </p>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="text-[15px] leading-relaxed mb-4 text-stone-700">
            Lançado! Distribuí 3 parcelas de{" "}
            <strong className="text-stone-900 font-semibold">R$ 29,96</strong> na fatura do seu{" "}
            <strong className="text-purple-600 font-semibold">Nubank</strong> para os próximos
            meses.
          </p>
        </>
      ),
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="text-[15px] leading-relaxed mb-4 text-stone-700">
            Analisando seus gastos fixos e a meta{" "}
            <strong className="text-stone-900 font-semibold">Trocar de Carro</strong>...{" "}
          ...
          <div className="bg-amber-50 rounded-xl p-3 text-sm border border-amber-200 border-l-4 border-l-amber-500">
            <p className="text-amber-900/90 text-[13px] leading-relaxed">
              <strong>Cautela.</strong> Essa parcela de R$ 416,00 reduzirá sua sobra mensal real
              para apenas R$ 150,00 até o meio do ano.
            </p>
          </div>
        </>
      ),
      ...
      content: (
        <>
          ...
          <p className="text-[15px] leading-relaxed text-stone-700">
            Registrado! Identifiquei a Tag de Conta Conjunta. O acerto de 50% (
            <strong className="text-emerald-700 font-semibold">R$ 60,00</strong>) já foi adicionado
            ao dashboard familiar.
          </p>
        </>
      ),
    },
...
export function ChatDemo() {
  ...
  return (
    <div
      className="flex-1 bg-[#efeae2] p-4 sm:p-5 flex flex-col gap-5 bg-cover bg-blend-soft-light relative overflow-y-auto scrollbar-hide"
      style={{
      ...
      <div className="chat-bubbles-container flex flex-col gap-4 justify-end min-h-full">
        {visibleMessages.map((msg: MessageNode, idx) => (
          <div
            ...
            className={`chat-bubble-enter flex flex-col ${msg.sender === "user" ? "items-end" : "items-start"}`}
          >
            {/* User Bubble */}
              ...
              <div className="bg-[#d9fdd3] text-[#111b21] rounded-2xl rounded-tr-sm px-4 py-3 max-w-[85%] shadow-sm relative">
                ...
                <div className="flex justify-end mt-1.5 gap-1 items-center">
                  ...
                  <svg
                    ...
                    width="16"
                    height="15"
                    className="text-info fill-current opacity-80"
                    style={{ color: "#53bdeb" }}
                  >
            ...
            {msg.sender === "user" && msg.type === "image" && (
              <div className="bg-[#d9fdd3] text-[#111b21] rounded-2xl rounded-tr-sm p-1 max-w-[85%] shadow-sm relative">
                <div className="w-[180px] h-[120px] bg-stone-200 rounded-xl overflow-hidden relative flex items-center justify-center border border-black/5">
                  ...
                  <span className="absolute bottom-2 left-2 text-[10px] font-medium text-stone-500">
                    Foto_recibo.jpg
                  </span>
                </div>
