...
import type {
  ImportacaoHistorico as HistoricoItem,
  StatusImportacao,
  TipoImportacao,
} from "@/lib/api";
          ...
          <div key={monthKey} className={cn(gi > 0 && "mt-5")}>
            ...
            <div className="space-y-1">
              {items.map((item, i) => {
                ...
                const pct =
                  item.qtdTransacoesEncontradas > 0
                    ? Math.round(
                        (item.qtdTransacoesImportadas / item.qtdTransacoesEncontradas) * 100
                      )
                    : 0;
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative shrink-0">
                      ...
                      <span
                        className={cn(
                          "absolute -top-0.5 -right-0.5 w-2.5 h-2.5 rounded-full ring-2 ring-white dark:ring-[#161B22]",
                          statusCfg.bg
                        )}
                    ...
                    <div className="shrink-0 text-right">
                      <p className="text-[10px] text-slate-400 font-medium">
                        {formatRelativeDate(item.criadoEm)}
                      </p>
                      {item.status === "Falhou" && (
