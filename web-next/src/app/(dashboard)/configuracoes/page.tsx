    ...
    <div className="flex flex-col lg:flex-row h-full -m-4 sm:-m-6 lg:-m-8 overflow-hidden">
      ...
      <div className="lg:hidden bg-white dark:bg-[#161B22] border-b border-slate-100 dark:border-slate-800">
        <div className="px-4 pt-4 pb-2">
          <h1 className="text-2xl serif-italic text-slate-900 dark:text-white tracking-tight">Configurações</h1>
          <p className="text-[9px] uppercase tracking-[0.2em] text-slate-400 font-bold mt-1">Personalize sua experiência</p>
        </div>
        <div className="flex overflow-x-auto gap-1 px-3 pb-2 hide-scrollbar">
          {SIDEBAR_LINKS.map((link) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "flex items-center gap-1.5 px-3 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider whitespace-nowrap transition-all shrink-0",
                  isActive
      ...
      <aside className="w-80 shrink-0 bg-white dark:bg-[#161B22] border-r border-slate-100 dark:border-slate-800 hidden lg:flex lg:flex-col">
        <div className="p-6 lg:p-10">
          <h1 className="text-3xl serif-italic text-slate-900 dark:text-white tracking-tight">Configurações</h1>
          <p className="text-[9px] uppercase tracking-[0.2em] text-slate-400 font-bold mt-2">Personalize sua experiência</p>
        </div>
        <nav className="flex-1 px-4 space-y-1">
          {SIDEBAR_LINKS.map((link) => {
            ...
            return (
              ...
              >
                <Icon className={cn("size-5", isActive ? "text-emerald-500" : "group-hover:text-emerald-500")} />
                {link.label}
              </button>
            );
          })}
      ...
      <section className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 xl:p-12 hide-scrollbar">
        <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12 pb-24">
          ...
          {/* ══════ 1. Perfil e Conta ══════ */}
          <div className="glass-card bg-white dark:bg-[#161B22] rounded-2xl sm:rounded-[2.5rem] lg:rounded-[3rem] p-5 sm:p-8 lg:p-12" id="section-perfil">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8 mb-6 sm:mb-10 pb-6 sm:pb-10 border-b border-slate-50 dark:border-slate-800">
              <div className="relative group">
                ...
                <button className="absolute bottom-0 right-0 bg-emerald-500 text-white p-2 rounded-full shadow-lg hover:bg-emerald-600 transition-all">
                  <Camera className="size-3.5" />
                </button>
              </div>
              <div>
                <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Perfil e Conta</h2>
                <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold mt-1">Gerencie seus dados pessoais</p>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 lg:gap-x-12 gap-y-6 sm:gap-y-8">
              {/* Nome */}
              <div className="space-y-2">
                <label className="text-[9px] uppercase tracking-widest font-bold text-slate-400">Nome Completo</label>
                <div className="relative group">
                  <input
              ...
              {/* Email (readonly) */}
              <div className="space-y-2">
                <label className="text-[9px] uppercase tracking-widest font-bold text-slate-400">Endereço de E-mail</label>
                <input
              ...
              {/* Renda Mensal */}
              <div className="space-y-2">
                <label className="text-[9px] uppercase tracking-widest font-bold text-slate-400">Renda Mensal</label>
                <div className="relative group">
                  <input
                    ...
                    type="text"
                    value={usuario.rendaMensal ? formatCurrency(usuario.rendaMensal) : "Não informada"}
                    readOnly
                  />
                  <button
                    onClick={() => {
              ...
              {/* CPF (readonly) */}
              <div className="space-y-2">
                <label className="text-[9px] uppercase tracking-widest font-bold text-slate-400">CPF</label>
                <input
                  className="w-full bg-slate-100/50 dark:bg-slate-800/50 border-transparent rounded-2xl px-5 py-4 text-sm font-medium text-slate-400 cursor-not-allowed"
                  type="text"
          ...
          <div className="glass-card bg-white dark:bg-[#161B22] rounded-2xl sm:rounded-[2.5rem] lg:rounded-[3rem] p-5 sm:p-8 lg:p-12" id="section-assinatura">
            <div className="flex items-center justify-between mb-10">
              <div>
                <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Plano e Assinatura</h2>
                <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold mt-1">Detalhes do seu serviço contratado</p>
              </div>
              {assinatura && (
                <span className={cn(
            ...
            {assinatura ? (
              <>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-12">
                  <div className="p-6 rounded-3xl bg-slate-50/50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700">
                    <p className="text-[9px] uppercase tracking-widest font-bold text-slate-400 mb-2">Plano Atual</p>
                    <p className="text-lg font-bold text-slate-900 dark:text-white">{assinatura.planoNome}</p>
                  </div>
                  <div className="p-6 rounded-3xl bg-slate-50/50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700">
                    <p className="text-[9px] uppercase tracking-widest font-bold text-slate-400 mb-2">Valor Mensal</p>
                    <p className="text-lg font-bold mono-data text-slate-900 dark:text-white">{formatCurrency(assinatura.valorMensal)}</p>
                  </div>
                  <div className="p-6 rounded-3xl bg-slate-50/50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700">
                    <p className="text-[9px] uppercase tracking-widest font-bold text-slate-400 mb-2">Próxima Cobrança</p>
              ...
              <div className="space-y-6">
                <div className="rounded-2xl border border-dashed border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/20 p-6">
                  <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-4">Bloqueado no seu plano atual</p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {[
                      ...
                      <div key={feat.label} className="flex items-center gap-3 p-3 rounded-xl bg-white dark:bg-slate-800/60 border border-slate-100 dark:border-slate-700 opacity-60">
                        <span className="text-base grayscale">{feat.icon}</span>
                        <span className="text-xs font-semibold text-slate-700 dark:text-slate-300">{feat.label}</span>
          ...
          <div className="glass-card bg-white dark:bg-[#161B22] rounded-2xl sm:rounded-[2.5rem] lg:rounded-[3rem] p-5 sm:p-8 lg:p-12" id="section-seguranca">
            <div className="mb-10">
              <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Segurança e Acesso</h2>
              <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold mt-1">Controle de credenciais e privacidade</p>
            </div>
            <div className="space-y-8">
              ...
              <div className="flex items-center justify-between p-8 rounded-3xl bg-slate-50/50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <p className="text-[11px] font-bold text-slate-900 dark:text-white uppercase tracking-widest">Senha de Acesso</p>
              ...
              <div className="p-8 rounded-3xl bg-rose-50/30 dark:bg-rose-950/10 border border-rose-100 dark:border-rose-900/30">
                <div className="flex items-start justify-between gap-4">
                  <div className="space-y-2">
                    <p className="text-[11px] font-bold text-rose-600 dark:text-rose-400 uppercase tracking-widest">Zona de Perigo</p>
                    <p className="text-sm text-rose-800 dark:text-rose-300 font-medium">Excluir Conta Permanentemente</p>
                    <p className="text-[11px] text-rose-400 max-w-md">
                      A exclusão é irreversível. Todos os seus dados financeiros, transações e configurações serão permanentemente removidos de nossos servidores.
                    </p>
                  </div>
                  <button
          ...
          {/* ══════ 4. Preferências ══════ */}
          <div className="glass-card bg-white dark:bg-[#161B22] rounded-2xl sm:rounded-[2.5rem] lg:rounded-[3rem] p-5 sm:p-8 lg:p-12" id="section-preferencias">
            <div className="mb-10">
              <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Preferências</h2>
              <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold mt-1">Personalização do sistema</p>
            </div>
            <div className="space-y-12">
              <div className="rounded-3xl border border-slate-100 bg-slate-50/70 p-6 dark:border-slate-700 dark:bg-slate-800/35">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="space-y-2">
                    <p className="text-[11px] font-bold text-slate-900 dark:text-white uppercase tracking-widest">Categorias financeiras</p>
                    <p className="text-sm text-slate-500 dark:text-slate-400 max-w-xl">
                      O catálogo de categorias saiu de configurações e ganhou uma guia própria para cadastro, revisão e manutenção.
                    </p>
                  </div>
                  <button
              ...
              <div className="space-y-6 pt-10 border-t border-slate-50 dark:border-slate-800">
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="text-[11px] font-bold text-slate-900 dark:text-white uppercase tracking-widest">Notificações por E-mail</p>
                    <p className="text-sm text-slate-400 font-medium">Receba alertas de gastos e vencimentos</p>
                  </div>
                  <Badge className="bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 border-0 text-xs">Em breve</Badge>
                </div>
                <div className="flex items-center justify-between opacity-50">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <p className="text-[11px] font-bold text-slate-900 dark:text-white uppercase tracking-widest">Resumo Financeiro Semanal</p>
                      <span className="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-500 text-[8px] font-bold rounded uppercase">Em Breve</span>
                    </div>
                    <p className="text-sm text-slate-400 font-medium">Um relatório detalhado toda segunda-feira</p>
                  </div>
          ...
          {/* ══════ 5. Suporte e Ajuda ══════ */}
          <div className="glass-card bg-white dark:bg-[#161B22] rounded-2xl sm:rounded-[2.5rem] lg:rounded-[3rem] p-5 sm:p-8 lg:p-12" id="section-suporte">
            <div className="mb-10">
              <h2 className="text-xl font-semibold text-slate-900 dark:text-white">Suporte e Ajuda</h2>
              <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold mt-1">Canais de atendimento ao cliente</p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[11px] font-bold text-slate-900 dark:text-white uppercase tracking-widest mb-1">E-mail</p>
                    <p className="text-sm text-emerald-600 dark:text-emerald-400 font-semibold">suporte@ravier.com.br</p>
                    <p className="text-[10px] text-slate-400 mt-2 font-medium">Segunda a Sexta, 09h às 18h</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-slate-50 dark:bg-slate-800 flex items-center justify-center text-slate-400 shrink-0">
                  ...
                  <div>
                    <p className="text-[11px] font-bold text-slate-900 dark:text-white uppercase tracking-widest mb-1">Central de Ajuda</p>
                    <p className="text-sm text-slate-600 dark:text-slate-400 font-medium">Acesse nossa base de conhecimento completa.</p>
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-[11px] font-bold uppercase tracking-widest text-slate-600 dark:text-slate-300">Relatar um problema</span>
                  </div>
                ...
                <div className="w-full flex items-center justify-between p-6 rounded-2xl bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-800">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <span className="block text-[11px] font-bold uppercase tracking-widest text-emerald-600 dark:text-emerald-400">Ravi no app</span>
                      <span className="block text-sm text-slate-500 dark:text-slate-400 mt-1">Use o botão flutuante no canto da tela para retomar ou iniciar um atendimento.</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <DialogHeader>
              <div className="flex items-center gap-3 rounded-2xl border border-emerald-600/8 bg-emerald-600/3 p-3.5 sm:gap-4 sm:p-4">
                ...
                <div className="min-w-0 flex-1 text-left">
                  <DialogTitle className="text-lg font-semibold sm:text-xl">Atualizar Renda</DialogTitle>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-3 rounded-xl border border-input bg-background px-4 py-3 focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2">
                  ...
                  <CurrencyInput
                    ...
                    onValueChange={(value) => rendaForm.setValue("rendaMensal", value, { shouldValidate: true })}
                    placeholder="0,00"
                  />
                </div>
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              <div className="flex items-center gap-3 rounded-2xl border border-emerald-600/8 bg-emerald-600/3 p-3.5 sm:gap-4 sm:p-4">
                ...
                <div className="min-w-0 flex-1 text-left">
                  <DialogTitle className="text-lg font-semibold sm:text-xl">Alterar Senha</DialogTitle>
                  <DialogDescription className="mt-0.5 truncate text-xs text-muted-foreground sm:text-[13px]">
