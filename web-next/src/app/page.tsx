...
import { ArrowRight, Check, Sparkles, Mic, Camera, Shield, Zap, TrendingUp, ChevronRight, ChevronDown, Activity, AlertCircle } from "lucide-react";
...
function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-white/80 backdrop-blur-2xl shadow-lg shadow-black/[0.03] border-b border-stone-100" : "bg-transparent"}`}>
      <div className="max-w-7xl mx-auto px-6 sm:px-12 flex items-center justify-between h-20">
        <Link href="/" className="flex items-center z-10">
          <Image src="/logo-text.png" alt="Ravier" width={100} height={30} className="object-contain" priority />
        </Link>
...
function Hero() {
  ...
  return (
    <section ref={containerRef} className="relative flex items-center pt-32 sm:pt-40 pb-20 overflow-hidden">
      {/* Background elements */}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-12">
        <div className="text-center max-w-4xl mx-auto mb-12">
          ...
          <h1 className="hero-title-line text-5xl sm:text-6xl md:text-7xl lg:text-8xl leading-[1.05] tracking-tight mb-8" style={{ fontFamily: "'Georgia', serif" }}>
          ...
          <p className="hero-subtitle text-lg sm:text-xl md:text-2xl text-stone-500 max-w-2xl mx-auto font-light leading-relaxed mb-10">
            Grave um áudio no WhatsApp dizendo quanto gastou. Tire foto do recibo. O Ravier organiza tudo — e ainda te avisa antes de gastar demais.
          </p>
        ...
        <div className="hero-cards-grid max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
          <div className="hero-float-card bg-white rounded-2xl p-5 shadow-lg shadow-stone-200/40 border border-stone-100 flex items-center gap-4 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 animate-[float_6s_ease-in-out_infinite]">
            ...
            <div>
              ...
              <p className="text-[10px] text-green-600 font-semibold mt-1">✓ Processado via WhatsApp</p>
            </div>
          </div>
          ...
          <div className="hero-float-card bg-white rounded-2xl p-5 shadow-lg shadow-stone-200/40 border border-stone-100 flex items-center gap-4 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 animate-[float_7s_ease-in-out_infinite_1s]">
            ...
            <div>
              ...
              <p className="text-[10px] text-emerald-600 font-semibold mt-1">✓ Categorizado automaticamente</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="como-funciona" ref={containerRef} className="py-16 sm:py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24">
        <div className="text-center mb-20">
          <p className="text-emerald-700 font-bold text-xs tracking-widest uppercase mb-4">Como funciona</p>
          <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-[#1a1a1a] leading-tight" style={{ fontFamily: "'Georgia', serif" }}>
          ...
          {steps.map((s) => (
            <div key={s.num} className="step-card group">
              <div className="relative bg-stone-50 rounded-[2rem] p-8 sm:p-10 border border-stone-200 hover:border-emerald-200 transition-all duration-500 hover:shadow-xl hover:shadow-emerald-100/50 h-full flex flex-col">
                {/* Step number */}
                <span className="text-7xl font-black text-stone-100 absolute top-6 right-8 select-none group-hover:text-emerald-100 transition-colors" style={{ fontFamily: "'Georgia', serif" }}>
                  {s.num}
                </span>
                ...
                {/* Content */}
                <h3 className="text-xl sm:text-2xl font-bold text-stone-800 mb-4" style={{ fontFamily: "'Georgia', serif" }}>
                  {s.title}
                </h3>
...
function Features() {
  ...
  return (
    <section id="recursos" ref={containerRef} className="py-20 sm:py-28 bg-stone-50 relative overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 sm:px-12">

        <div className="text-center mb-16 sm:mb-20 reveal-text">
          <p className="text-emerald-700 font-bold text-sm tracking-[0.2em] uppercase mb-6">A revolução invisível</p>
          <h2 className="text-4xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-[#1a1a1a] max-w-4xl mx-auto leading-[1.1]" style={{ fontFamily: "'Georgia', serif" }}>
        ...
        <div className="mb-24 sm:mb-32">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center reveal-text">
            ...
            <div className="flex flex-col justify-center order-2 lg:order-1">
              <p className="text-emerald-700 font-bold text-sm tracking-[0.2em] uppercase mb-6">Entrada Multimodal</p>
              <h3 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-stone-900 leading-[1.05] mb-8" style={{ fontFamily: "'Georgia', serif" }}>
                A IA lê seus recibos. <br /> Escuta seus áudios.
              </h3>
              <p className="text-xl text-stone-500 leading-relaxed mb-12 max-w-lg">
                Mande um áudio no trânsito ou a foto de uma nota fiscal. O Ravier extrai, categoriza e atualiza seu orçamento em tempo real. Pelo WhatsApp ou Telegram.
              </p>
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  <div key={item.name} className="flex items-center gap-4 p-4 bg-white rounded-2xl shadow-sm border border-stone-100 hover:shadow-md transition-shadow">
                    <div className="size-12 bg-emerald-50 rounded-xl flex items-center justify-center text-xl border border-emerald-100/50">
                      {item.icon}
                    </div>
                    <div className="flex-1">
                      <p className="text-[10px] text-emerald-600 font-bold tracking-wider uppercase mb-0.5">Ravier</p>
            ...
            {/* RIGHT: Phone Mockup */}
            <div className="flex items-center justify-center order-1 lg:order-2" style={{ perspective: "1200px" }}>
              <div style={{ transformStyle: "preserve-3d" }}>

                {/* Glow Behind Phone */}
                <div
                  className="absolute inset-0 w-full h-full bg-emerald-500/10 blur-[80px] rounded-full -z-10"
                />
                ...
                >
                  ...
                  <div className="bg-[#008069] px-4 py-3 pt-9 flex items-center gap-3 z-10 shadow-sm text-white">
                    <div className="size-9 rounded-full bg-white flex items-center justify-center text-emerald-700 font-bold text-sm shadow-sm">R</div>
                    <div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center reveal-text">
            ...
            <div className="relative bg-white rounded-3xl shadow-xl overflow-hidden p-8 sm:p-10 border border-stone-100 order-2 lg:order-1">
              <div className="flex items-start sm:items-center justify-between mb-8 flex-col sm:flex-row gap-4">
                <div>
                  <h4 className="font-bold text-stone-400 uppercase tracking-widest text-[10px] sm:text-xs mb-2">Insight Engine</h4>
                  <h3 className="text-xl sm:text-3xl font-bold text-stone-900 leading-tight" style={{ fontFamily: "'Georgia', serif" }}>Simulação Analítica</h3>
                </div>
              ...
              <div className="mb-8 p-5 sm:p-6 rounded-2xl bg-stone-50 border border-stone-200/60">
                <p className="text-stone-500 text-[11px] font-semibold mb-2 uppercase tracking-wide">Compra sob Análise:</p>
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3">
                  <h2 className="text-2xl sm:text-4xl font-black tracking-tight text-stone-900">Novo iPhone 16 Pro</h2>
              ...
              <div className="bg-amber-50 border border-amber-200/60 rounded-2xl p-5 sm:p-6 flex flex-col sm:flex-row items-start gap-5 shadow-sm">
                ...
                <div>
                  <h5 className="text-amber-800 font-bold text-lg mb-2">Impacto Médio na Liquidez</h5>
                  <p className="text-amber-700/80 text-sm leading-relaxed">
                    Esta aquisição comprometerá <strong className="text-amber-900 font-bold">22% da sua renda livre</strong> projetada nos próximos 8 meses. A meta de &quot;Viagem para Europa&quot; sofrerá um atraso de <strong className="text-amber-900 font-bold">2 meses</strong>.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center order-1 lg:order-2">
              <p className="text-emerald-700 font-bold text-sm tracking-[0.2em] uppercase mb-6">Motor de Simulação</p>
              <h3 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-stone-900 leading-[1.05] mb-8" style={{ fontFamily: "'Georgia', serif" }}>
              ...
              <p className="text-xl text-stone-500 leading-relaxed max-w-lg">
                Antes de parcelar a próxima compra, a engine de simulação do Ravier analisa seu fluxo de caixa dos próximos 12 meses e prevê o impacto exato no seu padrão de vida.
              </p>
            </div>
        ...
        <div>
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center reveal-text">
            ...
            <div className="flex flex-col justify-center">
              <p className="text-emerald-700 font-bold text-sm tracking-[0.2em] uppercase mb-6">Polo Familiar</p>
              <h3 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-stone-900 leading-[1.05] mb-8" style={{ fontFamily: "'Georgia', serif" }}>
                Um cofre de vidro para <br /> duas pessoas.
              </h3>
              <p className="text-xl text-stone-500 leading-relaxed max-w-lg">
                Compartilhe orçamento, metas e contas com seu parceiro ou outra pessoa de confiança, sem misturar tudo e sem perder a autonomia de cada conta.
              </p>
            </div>
            ...
            <div className="relative bg-white rounded-3xl shadow-xl overflow-hidden p-8 sm:p-10 border border-stone-100">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-10 gap-4">
                <div>
                  <h3 className="text-2xl sm:text-3xl font-bold text-stone-900 tracking-tight" style={{ fontFamily: "'Georgia', serif" }}>Polo Familiar</h3>
                  <p className="text-emerald-700 font-bold uppercase tracking-[0.2em] text-[10px] mt-2">Transparência Integrada</p>
                </div>
                <div className="flex -space-x-3">
                  <div className="size-12 rounded-full border-[3px] border-white bg-stone-100 flex items-center justify-center text-lg font-bold text-stone-600 shadow-md z-30">P</div>
                  <div className="size-12 rounded-full border-[3px] border-white bg-emerald-100 flex items-center justify-center text-lg font-bold text-emerald-800 shadow-md z-20">M</div>
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                ...
                <div className="bg-stone-50 rounded-2xl p-6 border border-stone-100">
                  <div className="flex justify-between items-center mb-4">
                    <span className="text-stone-500 font-bold text-xs uppercase tracking-wider">Orçamento da Casa</span>
                    <span className="text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-full text-[10px] uppercase tracking-widest font-black">Saudável</span>
                  </div>
                  <h4 className="text-3xl sm:text-4xl font-black text-stone-900 tracking-tight mb-1">R$ 5.400</h4>
                ...
                <div className="bg-stone-50 rounded-2xl p-6 border border-stone-100">
                  <div className="flex justify-between items-start mb-4 gap-2">
                    <div className="flex items-center gap-2">
                      <div className="size-7 rounded-full bg-sky-100 flex items-center justify-center text-xs font-bold text-sky-700">F</div>
                      <span className="text-stone-500 font-bold text-xs uppercase tracking-wider">Contribuição do membro</span>
                    </div>
                    <span className="text-sky-700 bg-sky-50 px-2.5 py-1 rounded-full text-[9px] uppercase tracking-widest font-black">Atualizado</span>
                  </div>
                  <h4 className="text-3xl sm:text-4xl font-black text-stone-900 tracking-tight mb-4">R$ 1.150 <span className="text-base font-bold text-stone-300">/ R$ 2.000</span></h4>

                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-2">
                        <Check className="size-4 text-emerald-500" />
                        <span className="text-stone-600 text-sm font-medium">Mercado compartilhado</span>
                      </div>
  ...
  return (
    <section ref={containerRef} className="py-24 sm:py-32 bg-stone-50">
      <div className="max-w-3xl mx-auto px-6 sm:px-12">
        <div className="text-center mb-20">
          <p className="text-emerald-700 font-bold text-sm tracking-[0.2em] uppercase mb-6">Dúvidas</p>
          <h2 className="text-4xl sm:text-5xl font-bold tracking-tight text-[#1a1a1a] leading-tight" style={{ fontFamily: "'Georgia', serif" }}>
          ...
          {faqs.map((faq, i) => (
            <div key={i} className="faq-item">
              ...
              >
                ...
                <ChevronDown className={`size-5 text-stone-400 shrink-0 transition-transform duration-300 ${openIndex === i ? 'rotate-180' : ''}`} />
              </button>
...
function Pricing() {
  return (
    <section id="planos" className="py-20 sm:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24">
        <div className="text-center mb-20">
          <p className="text-emerald-700 font-bold text-xs tracking-widest uppercase mb-4">Planos</p>
          <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-[#1a1a1a] mb-4" style={{ fontFamily: "'Georgia', serif" }}>
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="bg-stone-50 rounded-[2rem] p-8 sm:p-10 border border-stone-200 flex flex-col hover:shadow-xl hover:shadow-stone-200/50 transition-all duration-300">
            <h3 className="text-xl font-bold text-[#1a1a1a] mb-2" style={{ fontFamily: "'Georgia', serif" }}>Pessoal</h3>
            <p className="text-sm text-stone-500 mb-8">Pra quem quer organizar sua vida financeira sozinho.</p>
            <div className="mb-8">
              <span className="text-4xl font-black text-[#1a1a1a]">R$ 19</span>
              <span className="text-xs font-bold text-stone-400 uppercase tracking-wider">/mês</span>
            </div>
            <ul className="space-y-4 mb-10 text-sm text-stone-600 font-medium flex-1">
              <li className="flex items-start gap-3"><Check className="size-4 text-emerald-600 shrink-0 mt-0.5" /> Lançamentos por áudio e foto</li>
              <li className="flex items-start gap-3"><Check className="size-4 text-emerald-600 shrink-0 mt-0.5" /> Bot inteligente no WhatsApp e Telegram</li>
              <li className="flex items-start gap-3"><Check className="size-4 text-emerald-600 shrink-0 mt-0.5" /> Painel completo em tempo real</li>
              <li className="flex items-start gap-3"><Check className="size-4 text-emerald-600 shrink-0 mt-0.5" /> Até 5 metas simultâneas</li>
            </ul>
            <Link
          ...
          <div className="bg-white rounded-[2rem] p-8 sm:p-12 border-2 border-emerald-700 shadow-2xl shadow-emerald-100/30 relative flex flex-col transform md:scale-105 z-10">
            ...
            <h3 className="text-2xl font-bold text-[#1a1a1a] mb-2" style={{ fontFamily: "'Georgia', serif" }}>2 Pessoas</h3>
            <p className="text-sm text-stone-500 mb-8">Titular + 1 membro com compartilhamento opcional.</p>
            <div className="mb-8">
              <span className="text-5xl font-black text-[#1a1a1a]">R$ 49</span>
              <span className="text-xs font-bold text-emerald-700 uppercase tracking-wider">/mês</span>
            </div>
            <ul className="space-y-4 mb-10 text-sm text-stone-600 font-medium flex-1">
              <li className="flex items-start gap-3"><Sparkles className="size-4 text-emerald-600 shrink-0 mt-0.5" /> Titular + 1 membro</li>
              <li className="flex items-start gap-3"><Check className="size-4 text-emerald-600 shrink-0 mt-0.5" /> Divisão automática de despesas</li>
              <li className="flex items-start gap-3"><Check className="size-4 text-emerald-600 shrink-0 mt-0.5" /> Orçamento compartilhado opcional</li>
              <li className="flex items-start gap-3"><Check className="size-4 text-emerald-600 shrink-0 mt-0.5" /> Simulação de compras com IA</li>
              <li className="flex items-start gap-3 text-emerald-800 font-bold"><Check className="size-4 text-emerald-600 shrink-0 mt-0.5" /> Metas e dashboard em dupla</li>
            </ul>
            <Link
          ...
          {/* Empresarial */}
          <div className="bg-stone-50 rounded-[2rem] p-8 sm:p-10 border border-stone-200 flex flex-col hover:shadow-xl hover:shadow-stone-200/50 transition-all duration-300">
            <h3 className="text-xl font-bold text-[#1a1a1a] mb-2" style={{ fontFamily: "'Georgia', serif" }}>Empresarial</h3>
            <p className="text-sm text-stone-500 mb-8">Para empresas e equipes que precisam de mais.</p>
            <div className="mb-8">
              <span className="text-4xl font-black text-[#1a1a1a]">R$ 149</span>
              <span className="text-xs font-bold text-stone-400 uppercase tracking-wider">/mês</span>
            </div>
            <ul className="space-y-4 mb-10 text-sm text-stone-600 font-medium flex-1">
              <li className="flex items-start gap-3"><Check className="size-4 text-emerald-600 shrink-0 mt-0.5" /> Usuários ilimitados</li>
              <li className="flex items-start gap-3"><Check className="size-4 text-emerald-600 shrink-0 mt-0.5" /> Relatórios avançados</li>
              <li className="flex items-start gap-3"><Check className="size-4 text-emerald-600 shrink-0 mt-0.5" /> Integração com sistemas</li>
              <li className="flex items-start gap-3"><Check className="size-4 text-emerald-600 shrink-0 mt-0.5" /> Suporte prioritário</li>
            </ul>
            <Link
  ...
  return (
    <section ref={containerRef} className="py-32 bg-stone-50 relative overflow-hidden">
      ...
      <div className="cta-content relative z-10 max-w-3xl mx-auto text-center px-6">
        <h2 className="text-3xl sm:text-5xl font-bold text-[#1a1a1a] mb-6 leading-tight" style={{ fontFamily: "'Georgia', serif" }}>
          Pronto pra parar de se preocupar com dinheiro?
        </h2>
        <p className="text-lg text-stone-500 mb-10 max-w-xl mx-auto">
          Crie sua conta em 30 segundos. Conecte seu WhatsApp. E deixe a inteligência artificial cuidar do resto.
        </p>
        <Link
          href="/registro"
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 lg:gap-8 mb-12 pb-12 border-b border-stone-800">
          ...
          <div className="col-span-2 md:col-span-1">
            <Image src="/logo-text.png" alt="Ravier" width={100} height={30} className="object-contain brightness-0 invert opacity-90 mb-5" />
            <p className="text-stone-400 text-sm leading-relaxed mb-6">
              Controle financeiro inteligente pelo WhatsApp e Telegram. Para pessoas e famílias.
            </p>
            <a href="mailto:contato@ravier.com.br" className="text-emerald-400 text-sm font-medium hover:text-emerald-300 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-stone-400 font-medium">
              <li><Link href="/login" className="hover:text-emerald-400 transition-colors">Entrar</Link></li>
              <li><Link href="/registro" className="hover:text-emerald-400 transition-colors">Criar conta grátis</Link></li>
              <li><Link href="/recuperar-senha" className="hover:text-emerald-400 transition-colors">Recuperar senha</Link></li>
            </ul>
          </div>
